    ...
    <div className="h-full py-16 sm:py-24"
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          <h2 className="text-base font-semibold leading-7 text-indigo-600">Shop faster!</h2>
          <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
            Everything you need is guaranteed in our Store
          </p>
          <p className="mt-6 text-lg leading-8 text-gray-600">
          Anyone who shops at our shop will definitely feel the true of happiness in the world, without exception. Everyone</p>
        </div>
